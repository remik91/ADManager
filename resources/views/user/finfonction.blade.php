        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card bg-light mb-3">
                <div class="card-header bg-info text-white">
                    <i class="fa fa-info-circle"></i> Fin de Fonction
                </div>
                <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        Académique.
                        La liste ci-dessous présente tous les utilisateurs dont la fin de fonction est dépassée, ce qui
                        signifie
                        qu'ils ne font plus partie de l'académie.
                    </p>
                    <p class="card-text">
                        En règle générale, les comptes Active Directory peuvent être supprimés, mais par mesure de
                        précaution, ils
                        peuvent également être bloqués pour éviter toute action imprudente.
                    </p>
        ...
        <div class="col-md-12">
            <div class="card mb-3">
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    <form role="form" action="{{ route('user.finfonction') }}" method="GET" autocomplete="off">
